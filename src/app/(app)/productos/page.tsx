...
export default function ProductosPage() {
  ...
  function openNew() {
    setEditing(null);
    setForm({ name: "", sku: "", sku_externo: "", description: "", commercial_description: "", price: "", unit: "unidad", category_id: "", brand_id: "", stock_quantity: "", min_stock: "", requires_stock: false, is_premium: false, premium_level: 5, cost_price: "", uses_inputs: false, image_url: "", genera_diseno: false, diseno_template_url: "", alicuota: "", _pendingImage: "", _orig_image_url: "", _orig_commercial_description: "" });
    setComponents([]);
  ...
  function openEdit(p: Product) {
    ...
    setForm({
      ...
      alicuota: p.alicuota ? String(p.alicuota) : "",
      _pendingImage: "",
      _hasComponents: false,
          ...
          <div style={{ background: "#fff", borderRadius: "16px", padding: "24px", width: "100%", maxWidth: "640px", marginTop: "20px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", gridColumn: "1 / -1" }}>
                ...
                <Select label="Alícuota IVA" value={form.alicuota || ""} onChange={(v) => setForm({ ...form, alicuota: v })} options={[{ value: "", label: "Usar default del negocio" }, ...ivaOptions(ivaAlicuotas)]} />
              </div>
            </div>
              ...
              {form.genera_diseno && (
                <div style={{ marginTop: "8px" }}>
                  ...
                  >
                    ...
                    <option value="/templates/plantilla-camiseta.png">Camiseta manga corta</option>
                    <option value="/templates/plantilla-musculosa.png">Musculosa / sin mangas</option>
                  </select>
